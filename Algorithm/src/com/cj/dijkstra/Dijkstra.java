...
class Graph {
    ...
    //更新index顶点到周围顶点的距离喝周围顶点的前驱顶点
    private void update(int index) {
        int len = 0;
        //根据遍历我们的邻接矩阵的的 matrix[index]行
...
class VisitedVertex {
    ...
    //记录出发顶点到其他所有顶点的距离，比如G为出发顶点，就会记录G到其他顶点的距离，会动态更新，求最短距离就会存放到dis
    public int[] dis;
