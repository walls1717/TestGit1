...
public class Prim {
    public static void main(String[] args) {
        ...
        int verxt = data.length;
        //邻接矩阵的关系使用二维数组表示，10000表示这个大数，表示两个点不连通
        int[][] weight = new int[][]{
        ...
        //创建MGraph对象
        MGraph graph = new MGraph(verxt);
        //创建一个MinTree对象
        MinTree minTree = new MinTree();
        minTree.createGraph(graph, verxt, data, weight);
        //输出
